...
namespace VacationsModule.Infrastructure.Migrations
{
    ...
    [Migration("20230317210752_InitialCreation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VacationsModule.Domain.Entities.VacationRequestComment", b =>
                {
                    b.HasOne("VacationsModule.Domain.Entities.Employee", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VacationsModule.Domain.Entities.VacationRequest", null)
                        .WithMany("Comments")
