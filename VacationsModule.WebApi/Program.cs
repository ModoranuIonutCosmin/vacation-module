...
builder.Services
    ...
    .AddTransient<IEmployeesService, EmployeesesService>()
    ...
    .AddSingleton<JwtOptionsProvider>(_ => new JwtOptionsProvider
    (
...
static void AddDataAccessEF(WebApplicationBuilder builder)
{
    ...
    services.AddDbContext<VacationRequestsDBContext>(options =>
    {
        options.UseSqlServer(connectionString,
            ma =>
                ma.MigrationsAssembly(typeof(VacationRequestsDBContext).Assembly.FullName)
        );
