...
public class EmployeesesService : IEmployeesService
{
    ...
    private TimeSpan PERIOD_OF_VACATION_DAYS = TimeSpan.FromDays(365);


    public EmployeesesService(UserManager<ApplicationUser> userManager, IAuthorizationService authorizationService,
        ...
        var user = new Employee()
        {
            ...
            VacationDaysYearlyStatuses = new List<VacationDaysStatus>()
            {
                new VacationDaysStatus()
                {
                    ...
                    YearEndDate = registerData.EmploymentDate.Add(PERIOD_OF_VACATION_DAYS).AddDays(-1),
